CREATE DATABASE  IF NOT EXISTS `TheWay` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `TheWay`;
...
CREATE TABLE `caminhoneiro` (
  ...
  KEY `fk_caminhoneiro_cidade1_idx` (`cidade_cod_cidade`),
  CONSTRAINT `fk_caminhoneiro_cidade1` FOREIGN KEY (`cidade_cod_cidade`) REFERENCES `cidade` (`cod_cidade`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transportadora` (
  ...
  `cod_transportadora` int(11) NOT NULL AUTO_INCREMENT,
  `cidade_cod_cidade` int(11) NOT NULL,
...
-- Dump completed on 2018-09-03 11:32:33
